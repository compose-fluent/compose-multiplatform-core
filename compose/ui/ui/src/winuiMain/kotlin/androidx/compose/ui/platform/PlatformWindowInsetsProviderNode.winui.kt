...
abstract class PlatformWindowInsetsProviderNode(
    ...
    protected abstract fun calculatePlatformInsets(
...
private data class ExcludedWindowInsetsProviderModifierElement(
    ...
    override fun create(): ExcludedWindowInsetsProviderNode =
        ExcludedWindowInsetsProviderNode(safeInsets, ime)
...
private class ExcludedWindowInsetsProviderNode(
    ...
    override fun calculatePlatformInsets(
        ancestorWindowInsets: PlatformWindowInsets,
    ): PlatformWindowInsets = ancestorWindowInsets.excluding(safeInsets, ime)
