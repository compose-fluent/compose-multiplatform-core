...
- [x] Track embedded WinUI view bounds in the Owner and suppress duplicate Compose pointer dispatch for root events that fall inside native interop controls.
